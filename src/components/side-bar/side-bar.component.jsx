    ...
    return (
        <div className="side-bar">
            ...
            <div className="side-bar__bottom">
                <Link to="/about" className="side-bar__link">haqqımda</Link>
                <Link to="/sites" className="side-bar__link">
                    saytlarda və qəzetlərdə çıxışlarım
                </Link>
                <Link to="/tv" className="side-bar__link">televiziyada çıxışlarım</Link>
                <Link to="/scientific" className="side-bar__link">elmi fəaliyyətim</Link>
            </div>
        </div>
    )
}
